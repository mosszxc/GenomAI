...
| `5tJA4rinnJgd1LFO` | Buyer State Cleanup | Schedule | Auto-reset buyer_states после 15 мин AFK | ✅ #185 |
...
| `H1uuOanSy627H4kg` | Pipeline Health Monitor | Schedule | Мониторинг pipeline, Telegram алерты | ✅ |
