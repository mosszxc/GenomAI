...
GenomAI использует 25 активных workflow для оркестрации пайплайна. Все workflow следуют event-driven архитектуре с emit событий в Supabase.

**Последнее обновление:** 2025-12-30
**Статус:** 26/26 OPERATIONAL
...
| `pL6C4j1uiJLfVRIi` | Spy Creative Registration | Webhook | Регистрация spy креативов (конкуренты) | ✅ | ⏳ #165 |
...
| `H1uuOanSy627H4kg` | Pipeline Health Monitor | Schedule | Мониторинг pipeline, Telegram алерты | ✅ | ✅ NEW |
