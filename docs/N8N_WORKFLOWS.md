...
GenomAI использует 24 активных workflow для оркестрации пайплайна. Все workflow следуют event-driven архитектуре с emit событий в Supabase.

**Последнее обновление:** 2025-12-28
**Статус:** 25/25 OPERATIONAL
